...
namespace Assets.SuperGoalie.Scripts.Entities
{
    ...
    public class GoalKeeper : MonoBehaviour
    {
        ...
        private int GoalCaught = 0;
        public Text GoalKeeperScoreText;

        public void GoalKept()
        {
            GoalCaught++;
            GoalKeeperScoreText.text = GoalCaught.ToString();
        }

        public void ResetGoalKeeperScore()
        {
            GoalCaught = 0;
            GoalKeeperScoreText.text = GoalCaught.ToString();
